...
class _$ValueFailureTearOff {
  ...
  ListTooLong<T> lisTooLong<T>({@required T failedValue, int max}) {
...
mixin _$ValueFailure<T> {
  ...
  Result when<Result extends Object>({
    ...
    @required Result lisTooLong(T failedValue, int max),
  ...
  Result maybeWhen<Result extends Object>({
    ...
    Result lisTooLong(T failedValue, int max),
  ...
  Result map<Result extends Object>({
    ...
    @required Result lisTooLong(ListTooLong<T> value),
  ...
  Result maybeMap<Result extends Object>({
    ...
    Result lisTooLong(ListTooLong<T> value),
...
class _$ListTooLong<T> implements ListTooLong<T> {
  const _$ListTooLong({@required this.failedValue, this.max})
      : assert(failedValue != null);
  ...
  @override
  String toString() {
    return 'ValueFailure<$T>.lisTooLong(failedValue: $failedValue, max: $max)';
  }
  ...
  Result when<Result extends Object>({
    ...
    assert(invalidEmail != null);
    assert(shortPassword != null);
    return lisTooLong(failedValue, max);
  }
...
abstract class ListTooLong<T> implements ValueFailure<T> {
  const factory ListTooLong({@required T failedValue, int max}) =
      _$ListTooLong<T>;
